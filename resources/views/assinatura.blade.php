...
<div class=" row">
    ...
    <div id='card-principal' class='col-md-6 col-10 mx-auto d-flex flex-column'>
        ...
        <div class='mt-4'>
            <h2 class='h2-termos text-white'>Nossos termos de serviço :</h2>
            <div    class='caixa-termos'>

                <p class='termos text-black'>

                   1. DA FUNÇÃO DO SITE<br>
                    Este site foi criado e desenvolvido com a função de trazer conteúdo informativo de alta qualidade, a venda de produtos físicos, digitais e a divulgação de prestação de serviço. A NKW TECH busca através da criação de conteúdo de alta qualidade, desenvolvido por profissionais da área, trazer o conhecimento ao alcance de todos, assim como a divulgação dos próprios serviços.
                    ...
                    Todo o conteúdo é atualizado periodicamente, porém, pode conter em algum artigo, vídeo ou imagem, alguma informação que não reflita a verdade atual, não podendo a NKW TECH ser responsabilizada de nenhuma forma ou meio por qualquer conteúdo que não esteja devidamente atualizado.
                    ...
                    <br>2. DO ACEITE DOS TERMOS<br>
                    Este documento, chamado “Termos de Uso”, aplicáveis a todos os visitantes do site.

                    Este termo especifica e exige que todo usuário ao acessar o site da NKW TECH, leia e compreenda todas as cláusulas do mesmo, visto que ele estabelece entre a NKW TECH e o VISITANTE direitos e obrigações entre ambas as partes, aceitos expressamente pelo VISITANTE a permanecer navegando no site da NKW TECH.
                    ...
                    Este termo pode e irá ser atualizado periodicamente pela NKW TECH, que se resguarda no direito de alteração, sem qualquer tipo de aviso prévio e comunicação. É importante que o VISITANTE confira sempre se houve movimentação e qual foi a última atualização do mesmo no começo da página.

                   <br> 3. DO GLOSSÁRIO<br>
                    ...
                    Em caso de dúvidas sobre qualquer palavra utilizada neste termo, o VISITANTE deverá entrar em contato com a NKW TECH através dos canais de comunicação encontradas no site.

                   <br> 4. DO ACESSO AO SITE<br>
                    ...
                    A NKW TECH não se responsabiliza por nenhuma perda de oportunidade ou prejuízos que esta indisponibilidade temporária possa gerar aos usuários.

                    Em caso de manutenção que exigirem um tempo maior, a NKW TECH irá informar previamente aos clientes da necessidade e do tempo previsto em que o site ou plataforma ficará offline.
                    ...
                    Todos os dados estão protegidos conforme a Lei Geral de Proteção de Dados, e ao realizar o cadastro junto ao site, o VISITANTE concorda integralmente com a coleta de dados conforme a Lei e com a Política de Privacidade da NKW TECH.

                    <br>5. DA LICENÇA DE USO E CÓPIA<br>
                    ...
                    A NKW TECH poderá em casos concretos permitir pontualmente exceções a este direito, que serão claramente destacados no mesmo, com a forma e permissão de uso do conteúdo protegido. Este direito é revogável e limitado as especificações de cada caso.

                   <br> 6. DAS OBRIGAÇÕES<br>
                    O VISITANTE ao utilizar o website da NKW TECH, concorda integralmente em:
                    ...
                    <br>7. DA MONETIZAÇÃO E PUBLICIDADE<br>
                    A NKW TECH pode alugar ou vender espaços publicitários na plataforma, ou no site, diretamente aos anunciantes, ou através de empresas especializadas com o Adsense (Google), Taboola ou outras plataformas especializadas como o EletroCriticas.com
                    ...
                    Todas as propagandas no site ou plataforma serão claramente destacadas como publicidade, como forma de disclaimer da NKW TECH e de conhecimento do VISITANTE.
                    ...
                    <br>8. DOS TERMOS GERAIS <br>
                    O Site irá apresentar hiperlinks durante toda a sua navegação, que podem levar diretamente para outra página da NKW TECH ou para sites externos.

                    Apesar da NKW TECH apenas criar links para sites externos de extrema confiança, caso o usuário acesse um site externo, a NKW TECH não tem nenhuma responsabilidade pelo meio, sendo uma mera indicação de complementação de conteúdo, ficando o mesmo responsável pelo acesso, assim como sobre quaisquer ações que venham a realizar neste site.

                    Em caso que ocorra eventuais conflitos judiciais entre o VISITANTE e a NKW TECH, o foro elegido para a devida ação será o da comarca da NKW TECH, mesmo que haja outro mais privilegiado.
                    <br>9. DOS TERMOS DE SUPORTE PRESENCIAL <br>
                    O visitante ao aceitar nossos termos concorda em deixar nossa equipes de técnicos prestarmos nossos serviços presenciais, e a NKW TECH não se responsabiliza por defeitos e mau uso vindos por parte do VISITANTE
        ...
        <div class='text-center mt-4'>
            <form action="{{route('checkout')}}" method="POST">
                ...
                <div class=text-white>
                    <input id='termos' class='' type='checkbox' name='termos'>
